...
public class GUIExtremeCrafting extends GuiContainer {
    ...
    public GUIExtremeCrafting(InventoryPlayer par1InventoryPlayer, World par2World, int x, int y, int z,
    ...
    protected void drawGuiContainerForegroundLayer(int i, int j) {
        // this.fontRendererObj.drawString(StatCollector.translateToLocal("container.extreme_crafting"), 28, 6,
        // 4210752);
        // this.fontRendererObj.drawString(StatCollector.translateToLocal("container.inventory"), 8, this.ySize - 96 +
        // 2, 4210752);
    }
