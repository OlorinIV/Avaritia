...
public class ModelRendererWing extends ModelRenderer {
    ...
    public void render(float f) {
        /*
         * if (!this.isHidden && this.showModel) { //GL11.glCullFace(GL11.GL_BACK); GL11.glEnable(GL11.GL_CULL_FACE); }
         */
        super.render(f);
        /*
         * if (!this.isHidden && this.showModel) { //GL11.glCullFace(GL11.GL_NONE); GL11.glDisable(GL11.GL_CULL_FACE); }
         */
    }
}
